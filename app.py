...
with st.form("form_ulasan", clear_on_submit=True):
    ...
    with col1:
        ...
        fakultas = st.selectbox("Fakultas", [
            "Pilih Fakultas", "FT — Teknik", "FEB — Ekonomi & Bisnis",
            "FISIP — Ilmu Sosial", "FK — Kedokteran", "FMIPA — Sains",
            "FH — Hukum", "FKM — Kesehatan Masyarakat", "FP — Pertanian", "Lainnya"
        ])
    with col2:
        angkatan = st.selectbox("Angkatan", ["Pilih Angkatan", "2020", "2021", "2022", "2023", "2024"])
        layanan = st.selectbox("Kategori Layanan yang Dinilai", [
            "Pilih Kategori", "Akademik", "Perpustakaan", "Fasilitas Kampus",
            "Kantin", "Laboratorium", "Administrasi", "Konseling Mahasiswa",
            "IT & Sistem Informasi", "Dosen & Pengajaran", "Umum"
        ])
...
# ══════════════════════════════════════════════════════════════
# DASHBOARD (tampil kalau ada data)
# ══════════════════════════════════════════════════════════════
if len(responses) > 0:
    st.markdown("<hr class='divider'>", unsafe_allow_html=True)
    ...
    <div style="text-align:center; padding:3rem; color:#4a4f62;">
        ...
        <div style="font-size:1.1rem;">Belum ada data ulasan. Jadilah yang pertama mengisi!</div>
    </div>
    """, unsafe_allow_html=True)
